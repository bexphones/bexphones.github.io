...
var _tw = function _tw(p, n) {
	...
	tw[n].c = function () {
		if (p.c != null) {
			var time_adapted = p.d + p.t + p.ctime;
...
var _transition = function _transition(p) {
	//transition,game,parameter
	if (p.e == null) {
		p.e = Phaser.Easing.Linear.None;
	}
